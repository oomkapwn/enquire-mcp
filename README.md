...
[![tests](https://img.shields.io/badge/tests-1617%20passing-brightgreen.svg)](#️-trust)
...
**46 tools · 19 MCP prompts · 1617 unit tests · 50+ languages · v3.11.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **1617 unit tests · 9 release-required CI checks · 7 currently branch-protected** | ✅ | n/a | rare |
...
npm test       # full suite (1617 tests, ~12s)
