...
[![tests](https://img.shields.io/badge/tests-779%20passing-brightgreen.svg)](#trust)
...
**44 tools · 19 MCP prompts · 779 unit tests · 50+ languages · v3.6.x · semver-bound · MIT · SLSA-3.**
...
| **779 unit tests · 7 required + 4 advisory CI gates per PR** | ✅ | n/a | rare |
...
npm test       # full suite (779 tests, ~5s)
