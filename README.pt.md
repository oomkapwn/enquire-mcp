...
[![tests](https://img.shields.io/badge/tests-1455%20passing-brightgreen.svg)](#️-confiança)
...
**46 ferramentas · 19 prompts MCP · 1455+ testes unitários · 50+ idiomas · v3.11.x estável · vinculado a semver · MIT · proveniência de build no npm (SLSA L2).**
...
| **1455 testes unitários · 9 gates obrigatórios + 5 consultivos de CI por PR** | ✅ | n/d | raro |
...
npm test       # suíte completa (1455 testes, ~12s)
