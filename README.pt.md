...
[![tests](https://img.shields.io/badge/tests-1710%20passing-brightgreen.svg)](#️-confiança)
...
**46 ferramentas · 19 prompts MCP · 1710+ testes unitários · 50+ idiomas · v3.11.x estável · vinculado a semver · MIT · proveniência de build no npm (SLSA L2).**
...
| **Confiança de produção** | ✅ Somente leitura por padrão, filtros de privacidade, HTTP autenticado, contratos semver, 1710 testes, 9 gates de release e proveniência SLSA L2 |
...
| **1710 testes unitários · 9 checks de CI exigidos para release · 7 atualmente protegidos** | Postura de release verificada; o detalhe operacional está fixado abaixo. |
...
npm test       # suíte completa (1710 testes)
