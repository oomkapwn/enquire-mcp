...
**[⚡ Установка за 30 секунд](#-quick-start) · [🧠 Сценарии использования](#-use-cases) · [📊 Бенчмарки](./docs/benchmarks.md) · [📖 Справочник API](https://oomkapwn.github.io/enquire-mcp/) · [💬 Сравнение с альтернативами](./docs/COMPARISON.md)**
...
**46 инструментов · 19 MCP-промптов · 1329+ модульных тестов · 50+ языков · стабильная ветка v3.10.x · с гарантиями semver · MIT · подтверждённая сборка в npm (SLSA L2).**
...
| **1329 модульных тестов · 9 обязательных + 5 совещательных CI-гейтов на каждый PR** | ✅ | н/д | редко |
...
| **Frontmatter** | `js-yaml@4` `load` (YAML 1.2 core schema, безопасно по умолчанию) — без выполнения кода |
...
npm test       # полный набор (1329 тестов, ~12с)
