...
[![tests](https://img.shields.io/badge/tests-1479%20passing-brightgreen.svg)](#️-vertrauen)
...
**46 Tools · 19 MCP-Prompts · 1479+ Unit-Tests · 50+ Sprachen · v3.11.x stable · semver-gebunden · MIT · npm-Build-Provenienz (SLSA L2).**
...
| **1479 Unit-Tests · 9 erforderliche + 5 beratende CI-Gates pro PR** | ✅ | n. z. | selten |
...
npm test       # vollständige Suite (1479 Tests, ~12 s)
