...
В [GitHub Release `v4.0.0-rc.6`](https://github.com/oomkapwn/enquire-mcp/releases/tag/v4.0.0-rc.6) доступен `enquire-mcp-basic-4.0.0-rc.6.mcpb` вместе с checksum, инвентарём, SBOM, notices и provenance. Бандл включает JavaScript-код сервера и обычные зависимости; совместимый MCPB-хост должен предоставить Node.js 22.13 или новее.
