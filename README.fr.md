...
[![tests](https://img.shields.io/badge/tests-1740%20passing-brightgreen.svg)](#️-confiance)
...
**46 outils · 19 prompts MCP · 1740+ tests unitaires · 50+ langues · v3.11.x stable · lié au semver · MIT · provenance de build npm (SLSA L2).**
...
| **Confiance en production** | ✅ Lecture seule par défaut, filtres de confidentialité, HTTP authentifié, contrats semver, 1740 tests, 9 gates de publication et provenance SLSA L2 |
...
```bash
npm install -g @oomkapwn/enquire-mcp@3.12.0-rc.21      # exact prerelease package
enquire-mcp --version
...
| **1740 tests unitaires · 9 contrôles CI requis pour la release · 7 actuellement protégés** | Posture de publication vérifiée ; le détail opérationnel est fixé ci-dessous. |
...
npm test       # suite complète (1740 tests)
