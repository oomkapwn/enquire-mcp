...
[![tests](https://img.shields.io/badge/tests-1748%20contracts-brightgreen.svg)](#️-trust)
...
**46 tools · 19 MCP prompts · 1748 unit tests · 50+ languages · v3.11.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **1748 tests + 9 release gates + signed npm provenance** | ✅ | ✕ | ✕ | ✕ |
...
| **1748 tests · 9 release-required CI checks · 7 branch-protected** | Current verified release posture; the operational breakdown is pinned below. |
