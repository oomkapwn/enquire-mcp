...
- **Process maturity** — 1020 tests, 9 required CI gates, semver-bound public surface, signed npm build provenance (SLSA Build L2), 11 state-driven OIA drift checks, structural invariant suite.
