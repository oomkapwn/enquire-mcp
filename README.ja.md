...
**46 ツール · 19 MCP プロンプト · 1773+ ユニットテスト · 50+ 言語 · v3.11.x 安定版 · semver 準拠 · MIT · npm ビルドプロベナンス（SLSA L2）。**
...
| **プロダクションの信頼性** | ✅ 既定で read-only、privacy filter、認証 HTTP、semver 契約、1773 tests、9 release gates、SLSA L2 provenance |
...
| **1773 ユニットテスト · リリース必須 CI チェック 9 個 · 現在ブランチ保護対象は 7 個** | 現在確認済みのリリース状態。運用詳細は下に固定しています。 |
