...
[![tests](https://img.shields.io/badge/tests-1669%20passing-brightgreen.svg)](#️-confiance)
...
**46 outils · 19 prompts MCP · 1669+ tests unitaires · 50+ langues · v3.11.x stable · lié au semver · MIT · provenance de build npm (SLSA L2).**
...
| **1669 tests unitaires · 9 contrôles CI requis pour la release · 7 actuellement protégés** | ✅ | s.o. | rare |
...
npm test       # suite complète (1669 tests)
