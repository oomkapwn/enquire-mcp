...
[![tests](https://img.shields.io/badge/tests-2272%20contracts-brightgreen.svg)](#️-신뢰)
...
**도구 47개 · MCP 프롬프트 19개 · 단위 테스트 2272+개 · 50+ 개 언어 · v3.11.x stable · semver 결속 · MIT · npm 빌드 출처 증명(SLSA L2).**
...
| **프로덕션 신뢰** | ✅ 기본 read-only, privacy filter, 인증 HTTP, semver contracts, 2272 tests, 13 release gates, SLSA L2 provenance |
...
총 47개 도구: 상시 활성 읽기 35개(우산 격인 `obsidian_search` 포함) + 선택형 읽기 4개 + 게이트된 쓰기 7개 + 폐루프 피드백 1개. 전체 레퍼런스: **[docs/api.md](./docs/api.md)**.
...
| **단위 테스트 2272개 · 릴리스 필수 CI 검사 13개 · 현재 브랜치 보호 전체 13개** | 현재 검증된 릴리스 상태이며 운영 세부사항은 아래에 고정되어 있습니다. |
