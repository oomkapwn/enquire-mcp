...
**46 टूल · 19 MCP प्रॉम्प्ट · 1773+ यूनिट टेस्ट · 50+ भाषाएँ · v3.11.x स्थिर · semver-बाध्य · MIT · npm बिल्ड प्रोवेनेंस (SLSA L2)।**
...
| **Production trust** | ✅ read-only default, privacy filters, authenticated HTTP, semver contracts, 1773 tests, 9 release gates और SLSA L2 provenance |
...
| **1773 यूनिट टेस्ट · 9 release-required CI जाँच · वर्तमान में 7 branch-protected** | वर्तमान verified release posture; operational detail नीचे pinned है। |
