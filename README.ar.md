...
**46 أداة · 19 موجِّه MCP · 1624+ اختبار وحدة · 50+ لغة · إصدار مستقر v3.11.x · مُقيَّد بالـ semver · MIT · إثبات بناء npm (SLSA L2).**
...
| **1624 اختبار وحدة · 9 فحوص CI مطلوبة للإصدار · 7 محمية حالياً على الفرع** | ✅ | غير منطبق | نادر |
