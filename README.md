...
[![tests](https://img.shields.io/badge/tests-715%20passing-brightgreen.svg)](#trust)
...
**44 tools · 19 MCP prompts · 715 unit tests · 50+ languages · v3.5.x · semver-bound · MIT · SLSA-3.**
...
| **715 unit tests · 7 required + 4 advisory CI gates per PR** | ✅ | n/a | rare |
...
npm test       # full suite (715 tests, ~5s)
