...
**46 أداة · 19 موجِّه MCP · 1692+ اختبار وحدة · 50+ لغة · إصدار مستقر v3.11.x · مُقيَّد بالـ semver · MIT · إثبات بناء npm (SLSA L2).**
...
| **ثقة الإنتاج** | ✅ قراءة فقط افتراضياً ومرشحات خصوصية وHTTP موثّق وعقود semver و1692 اختباراً و9 بوابات إصدار ومصدر SLSA L2 |
...
| **1692 اختبار وحدة · 9 فحوص CI مطلوبة للإصدار · 7 محمية حالياً على الفرع** | وضع إصدار متحقق منه؛ والتفاصيل التشغيلية مثبتة أدناه. |
