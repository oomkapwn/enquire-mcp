...
[![tests](https://img.shields.io/badge/tests-2270%20contracts-brightgreen.svg)](#️-vertrauen)
...
| **Produktionsvertrauen** | ✅ Standardmäßig read-only, Privacy-Filter, authentifiziertes HTTP, Semver-Verträge, 2270 Tests, 13 Release-Gates und SLSA-L2-Provenienz |
...
| **2270 Unit-Tests · 13 release-erforderliche CI-Checks · alle 13 aktuell branch-geschützt** | Aktuell verifizierte Release-Posture; die operativen Details sind unten fixiert. |
...
npm test       # vollständige Suite (2270 Tests)
