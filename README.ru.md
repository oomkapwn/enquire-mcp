...
[![tests](https://img.shields.io/badge/tests-2272%20contracts-brightgreen.svg)](#️-доверие)
...
**47 инструментов · 19 MCP-промптов · 2272+ модульных тестов · 50+ языков · стабильная ветка v3.11.x · с гарантиями semver · MIT · подтверждённая сборка в npm (SLSA L2).**
...
| **Продакшен-доверие** | ✅ Read-only по умолчанию, privacy-фильтры, авторизованный HTTP, semver-контракты, 2272 тестов, 13 релизных гейтов и SLSA L2 provenance |
...
| **2272 модульных тестов · 13 обязательных для релиза CI-проверок · все 13 сейчас защищают ветку** | Текущая проверенная релизная позиция; операционная детализация закреплена ниже. |
...
npm test       # полный набор (2272 тестов)
