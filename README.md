...
[![tests](https://img.shields.io/badge/tests-1624%20passing-brightgreen.svg)](#️-trust)
...
**46 tools · 19 MCP prompts · 1624 unit tests · 50+ languages · v3.11.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **1624 unit tests · 9 release-required CI checks · 7 currently branch-protected** | ✅ | n/a | rare |
...
npm test       # full suite (1624 tests, ~12s)
