...
[![tests](https://img.shields.io/badge/tests-1773%20contracts-brightgreen.svg)](#️-trust)
...
**46 tools · 19 MCP prompts · 1773 unit tests · 50+ languages · v3.11.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **1773 tests + 9 release gates + signed npm provenance** | ✅ | ✕ | ✕ | ✕ |
...
| **Watcher startup** | Final-state activation waits for late EmbedDb/OCR/HNSW attachment; bounded pre-ready drift audit + private process-restart interlock prevent an interrupted guarded generation from being published automatically |
| **1773 tests · 9 release-required CI checks · 7 branch-protected** | Current verified release posture; the operational breakdown is pinned below. |
