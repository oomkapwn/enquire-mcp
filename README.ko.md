...
[![tests](https://img.shields.io/badge/tests-1594%20passing-brightgreen.svg)](#️-신뢰)
...
**도구 46개 · MCP 프롬프트 19개 · 단위 테스트 1594+개 · 50+ 개 언어 · v3.11.x stable · semver 결속 · MIT · npm 빌드 출처 증명(SLSA L2).**
...
| **단위 테스트 1594개 · PR당 필수 9개 + 권고 5개 CI 게이트** | ✅ | 해당 없음 | 드묾 |
