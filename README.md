...
[![tests](https://img.shields.io/badge/tests-1776%20contracts-brightgreen.svg)](#️-trust)
...
**46 tools · 19 MCP prompts · 1776 unit tests · 50+ languages · v3.11.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **1776 tests + 9 release gates + signed npm provenance** | ✅ | ✕ | ✕ | ✕ |
...
| **Watcher consistency** | Final-state startup activation waits for late sinks; each live Markdown/PDF attempt stages FTS5 + embeddings from one physical generation, retries one drift once, commits without yielding, and quarantines an uncertain semantic route instead of serving mixed state |
| **1776 tests · 9 release-required CI checks · 7 branch-protected** | Current verified release posture; the operational breakdown is pinned below. |
