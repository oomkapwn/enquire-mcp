...
| **Confianza para producción** | ✅ Solo lectura por defecto, filtros de privacidad, HTTP autenticado, contratos semver, 2270 pruebas, 13 gates de publicación y procedencia SLSA L2 |
...
| **2270 pruebas unitarias · 13 comprobaciones de CI requeridas para release · las 13 protegidas actualmente** | Estado de publicación verificado; el detalle operativo está fijado debajo. |
