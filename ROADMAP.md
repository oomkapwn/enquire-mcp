...
> Public roadmap for **enquire-mcp**, the #1 Obsidian MCP for AI memory and local document intelligence backed by your own vault. Updated 2026-07-29 (v3.12.0-rc.22 candidate: exact Node 22.13.0 floor validation in required Linux CI; runtime unchanged).
>
...
- **Process maturity** — 1740 tests, 9 release-required CI checks (7 currently branch-protected), semver-bound public surface, signed npm build provenance (SLSA Build L2), 12 state-driven OIA drift checks, structural invariant suite.
