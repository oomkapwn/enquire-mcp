...
## Published dependency resolution (introduced in v3.11.7-rc.8; current at v4.0.0-rc.4)
...
As of the current v4.0.0-rc.4 maintenance line, the published-consumer audit policy has exactly two configured
...
## MCPB Basic boundary (`v4.0.0-rc.4`; introduced in `v4.0.0-rc.2`)
