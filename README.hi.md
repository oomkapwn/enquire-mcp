...
**46 टूल · 19 MCP प्रॉम्प्ट · 1740+ यूनिट टेस्ट · 50+ भाषाएँ · v3.11.x स्थिर · semver-बाध्य · MIT · npm बिल्ड प्रोवेनेंस (SLSA L2)।**
...
| **Production trust** | ✅ read-only default, privacy filters, authenticated HTTP, semver contracts, 1740 tests, 9 release gates और SLSA L2 provenance |
...
स्वचालित रूप से उत्पन्न **[oomkapwn.github.io/enquire-mcp पर API संदर्भ](https://oomkapwn.github.io/enquire-mcp/api/)** — हर टूल, प्रॉम्प्ट और निर्यातित helper के साथ पूर्ण TSDoc (`@param` / `@returns` / `@example`)। हर `main` पर push के साथ स्रोत से [`publish-docs.yml`](https://github.com/oomkapwn/enquire-mcp/blob/main/.github/workflows/publish-docs.yml) (TypeDoc → GitHub Pages) के माध्यम से पुनर्निर्मित। निर्माण-द्वारा बहाव-मुक्त: वही TSDoc जो AI एजेंट और IDE देखते हैं, वही प्रकाशित होता है।
...
| **1740 यूनिट टेस्ट · 9 release-required CI जाँच · वर्तमान में 7 branch-protected** | वर्तमान verified release posture; operational detail नीचे pinned है। |
