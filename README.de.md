...
[![tests](https://img.shields.io/badge/tests-1776%20contracts-brightgreen.svg)](#️-vertrauen)
...
**46 Tools · 19 MCP-Prompts · 1776+ Unit-Tests · 50+ Sprachen · v3.11.x stable · semver-gebunden · MIT · npm-Build-Provenienz (SLSA L2).**
...
| **Produktionsvertrauen** | ✅ Standardmäßig read-only, Privacy-Filter, authentifiziertes HTTP, Semver-Verträge, 1776 Tests, 9 Release-Gates und SLSA-L2-Provenienz |
...
| **1776 Unit-Tests · 9 release-erforderliche CI-Checks · aktuell 7 branch-geschützt** | Aktuell verifizierte Release-Posture; die operativen Details sind unten fixiert. |
...
npm test       # vollständige Suite (1776 Tests)
