...
[![tests](https://img.shields.io/badge/tests-1273%20passing-brightgreen.svg)](#trust)
...
**45 tools · 19 MCP prompts · 1273 unit tests · 50+ languages · v3.9.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **1273 unit tests · 9 required + 5 advisory CI gates per PR** | ✅ | n/a | rare |
...
npm test       # full suite (1273 tests, ~12s)
