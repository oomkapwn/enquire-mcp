...
[![tests](https://img.shields.io/badge/tests-1566%20passing-brightgreen.svg)](#️-confiance)
...
**46 outils · 19 prompts MCP · 1566+ tests unitaires · 50+ langues · v3.11.x stable · lié au semver · MIT · provenance de build npm (SLSA L2).**
...
| **1566 tests unitaires · 9 portes CI requises + 5 indicatives par PR** | ✅ | s.o. | rare |
...
npm test       # suite complète (1566 tests, ~12 s)
