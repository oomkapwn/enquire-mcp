...
[![tests](https://img.shields.io/badge/tests-898%20passing-brightgreen.svg)](#trust)
...
**44 tools · 19 MCP prompts · 898 unit tests · 50+ languages · v3.8.x stable · semver-bound · MIT · SLSA-3 signed.**
...
| **898 unit tests · 9 required + 4 advisory CI gates per PR** | ✅ | n/a | rare |
...
> Strategic claim: enquire-mcp is the open-source backend for [Karpathy-style LLM Wikis](https://gist.github.com/karpathy/442a6bf555914898e9891c11519de94f) on top of your existing Obsidian vault. Knowledge that compounds, traceable to sources.
...
npm test       # full suite (898 tests, ~5s)
