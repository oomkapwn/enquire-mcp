...
**47 herramientas · 19 prompts MCP · 2272+ pruebas unitarias · 50+ idiomas · v3.11.x estable · ligado a semver · MIT · procedencia de compilación en npm (SLSA L2).**
...
| **Confianza para producción** | ✅ Solo lectura por defecto, filtros de privacidad, HTTP autenticado, contratos semver, 2272 pruebas, 13 gates de publicación y procedencia SLSA L2 |
...
| **2272 pruebas unitarias · 13 comprobaciones de CI requeridas para release · las 13 protegidas actualmente** | Estado de publicación verificado; el detalle operativo está fijado debajo. |
