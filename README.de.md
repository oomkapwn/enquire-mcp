...
[![tests](https://img.shields.io/badge/tests-2246%20contracts-brightgreen.svg)](#️-vertrauen)
...
**46 Tools · 19 MCP-Prompts · 2246+ Unit-Tests · 50+ Sprachen · v3.11.x stable · semver-gebunden · MIT · npm-Build-Provenienz (SLSA L2).**
...
| **Produktionsvertrauen** | ✅ Standardmäßig read-only, Privacy-Filter, authentifiziertes HTTP, Semver-Verträge, 2246 Tests, 13 Release-Gates und SLSA-L2-Provenienz |
...
| **2246 Unit-Tests · 13 release-erforderliche CI-Checks · alle 13 aktuell branch-geschützt** | Aktuell verifizierte Release-Posture; die operativen Details sind unten fixiert. |
...
npm test       # vollständige Suite (2246 Tests)
