...
[![tests](https://img.shields.io/badge/tests-1703%20passing-brightgreen.svg)](#️-trust)
...
**46 tools · 19 MCP prompts · 1703 unit tests · 50+ languages · v3.11.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **Production trust** | ✅ Read-only by default, privacy filters, authenticated HTTP, semver contracts, 1703 tests, 9 release gates, SLSA L2 provenance |
...
| **1703 tests · 9 release-required CI checks · 7 branch-protected** | Current verified release posture; the operational breakdown is pinned below. |
