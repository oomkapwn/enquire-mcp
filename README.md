...
[![tests](https://img.shields.io/badge/tests-1164%20passing-brightgreen.svg)](#trust)
...
**45 tools · 19 MCP prompts · 1164 unit tests · 50+ languages · v3.9.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
npm test       # full suite (1164 tests, ~12s)
