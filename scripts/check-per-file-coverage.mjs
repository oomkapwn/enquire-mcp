...
const FLOORS = {
  "src/embeddings.ts": { branches: 28 }, // current 29.82% (integration-dep; rc.42 F1 serve-offline guard added uncovered branches — applyOfflineEnv + offline-catch need a real model load; still > floor)
