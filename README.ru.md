...
[![tests](https://img.shields.io/badge/tests-2228%20contracts-brightgreen.svg)](#️-доверие)
...
**46 инструментов · 19 MCP-промптов · 2228+ модульных тестов · 50+ языков · стабильная ветка v3.11.x · с гарантиями semver · MIT · подтверждённая сборка в npm (SLSA L2).**
...
| **Продакшен-доверие** | ✅ Read-only по умолчанию, privacy-фильтры, авторизованный HTTP, semver-контракты, 2228 тестов, 13 релизных гейтов и SLSA L2 provenance |
...
В [GitHub Release `v4.0.0-rc.5`](https://github.com/oomkapwn/enquire-mcp/releases/tag/v4.0.0-rc.5) доступен `enquire-mcp-basic-4.0.0-rc.5.mcpb` вместе с checksum, инвентарём, SBOM, notices и provenance. Бандл включает JavaScript-код сервера и обычные зависимости; совместимый MCPB-хост должен предоставить Node.js 22.13 или новее.
...
| **2228 модульных тестов · 13 обязательных для релиза CI-проверок · все 13 сейчас защищают ветку** | Текущая проверенная релизная позиция; операционная детализация закреплена ниже. |
...
npm test       # полный набор (2228 тестов)
