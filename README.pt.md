...
[![tests](https://img.shields.io/badge/tests-2212%20contracts-brightgreen.svg)](#️-confiança)
...
**46 ferramentas · 19 prompts MCP · 2212+ testes unitários · 50+ idiomas · v3.11.x estável · vinculado a semver · MIT · proveniência de build no npm (SLSA L2).**
...
| **Confiança de produção** | ✅ Somente leitura por padrão, filtros de privacidade, HTTP autenticado, contratos semver, 2212 testes, 13 gates de release e proveniência SLSA L2 |
...
| **2212 testes unitários · 13 checks de CI exigidos para release · todos os 13 atualmente protegidos** | Postura de release verificada; o detalhe operacional está fixado abaixo. |
...
npm test       # suíte completa (2212 testes)
