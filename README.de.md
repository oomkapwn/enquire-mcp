...
[![tests](https://img.shields.io/badge/tests-1624%20passing-brightgreen.svg)](#️-vertrauen)
...
**46 Tools · 19 MCP-Prompts · 1624+ Unit-Tests · 50+ Sprachen · v3.11.x stable · semver-gebunden · MIT · npm-Build-Provenienz (SLSA L2).**
...
| **1624 Unit-Tests · 9 release-erforderliche CI-Checks · aktuell 7 branch-geschützt** | ✅ | n. z. | selten |
...
npm test       # vollständige Suite (1624 Tests, ~12 s)
