...
[GitHub Release `v4.0.0-rc.5`](https://github.com/oomkapwn/enquire-mcp/releases/tag/v4.0.0-rc.5) 提供 `enquire-mcp-basic-4.0.0-rc.5.mcpb`，以及校验和、清单、SBOM、许可声明和来源证明。包内包含服务器 JavaScript 和普通依赖；兼容的 MCPB 主机必须提供 Node.js 22.13 或更高版本。
