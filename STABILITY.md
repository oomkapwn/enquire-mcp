...
`4.0.0-rc.7` is the current tracked source for the deliberate major boundary for the official MCP TypeScript SDK v2 and MCP protocol revision `2026-07-28`:
