...
**46 ツール · 19 MCP プロンプト · 2207+ ユニットテスト · 50+ 言語 · v3.11.x 安定版 · semver 準拠 · MIT · npm ビルドプロベナンス（SLSA L2）。**
...
| **プロダクションの信頼性** | ✅ 既定で read-only、privacy filter、認証 HTTP、semver 契約、2207 tests、13 release gates、SLSA L2 provenance |
...
| **2207 ユニットテスト · リリース必須 CI チェック 13 個 · 現在ブランチ保護対象は全 13 個** | 現在確認済みのリリース状態。運用詳細は下に固定しています。 |
