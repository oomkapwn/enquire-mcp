...
[![tests](https://img.shields.io/badge/tests-2212%20contracts-brightgreen.svg)](#️-confiance)
...
**46 outils · 19 prompts MCP · 2212+ tests unitaires · 50+ langues · v3.11.x stable · lié au semver · MIT · provenance de build npm (SLSA L2).**
...
| **Confiance en production** | ✅ Lecture seule par défaut, filtres de confidentialité, HTTP authentifié, contrats semver, 2212 tests, 13 gates de publication et provenance SLSA L2 |
...
La [GitHub Release `v4.0.0-rc.4`](https://github.com/oomkapwn/enquire-mcp/releases/tag/v4.0.0-rc.4) fournit `enquire-mcp-basic-4.0.0-rc.4.mcpb` avec sa somme de contrôle, son inventaire, son SBOM, ses notices et sa provenance. Le bundle contient le JavaScript serveur et les dépendances ordinaires ; l'hôte MCPB compatible doit fournir Node.js 22.13 ou plus récent.
...
| **2212 tests unitaires · 13 contrôles CI requis pour la release · les 13 actuellement protégés** | Posture de publication vérifiée ; le détail opérationnel est fixé ci-dessous. |
...
npm test       # suite complète (2212 tests)
