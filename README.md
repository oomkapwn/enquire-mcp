...
[![tests](https://img.shields.io/badge/tests-1567%20passing-brightgreen.svg)](#️-trust)
...
**46 tools · 19 MCP prompts · 1567 unit tests · 50+ languages · v3.11.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **1567 unit tests · 9 required + 5 advisory CI gates per PR** | ✅ | n/a | rare |
...
npm test       # full suite (1567 tests, ~12s)
