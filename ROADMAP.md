...
- **Process maturity** — 966 tests, 9 required CI gates, semver-bound public surface, signed npm build provenance (SLSA Build L2), 8 state-driven OIA drift checks, structural invariant suite.
