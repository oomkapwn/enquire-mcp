...
[![tests](https://img.shields.io/badge/tests-1773%20contracts-brightgreen.svg)](#️-신뢰)
...
**도구 46개 · MCP 프롬프트 19개 · 단위 테스트 1773+개 · 50+ 개 언어 · v3.11.x stable · semver 결속 · MIT · npm 빌드 출처 증명(SLSA L2).**
...
| **프로덕션 신뢰** | ✅ 기본 read-only, privacy filter, 인증 HTTP, semver contracts, 1773 tests, 9 release gates, SLSA L2 provenance |
...
| **단위 테스트 1773개 · 릴리스 필수 CI 검사 9개 · 현재 브랜치 보호 7개** | 현재 검증된 릴리스 상태이며 운영 세부사항은 아래에 고정되어 있습니다. |
