...
- **Process maturity** — 997 tests, 9 required CI gates, semver-bound public surface, signed npm build provenance (SLSA Build L2), 10 state-driven OIA drift checks, structural invariant suite.
