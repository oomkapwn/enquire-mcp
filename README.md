...
[![tests](https://img.shields.io/badge/tests-1439%20passing-brightgreen.svg)](#️-trust)
...
| **1439 unit tests · 9 required + 5 advisory CI gates per PR** | ✅ | n/a | rare |
...
npm test       # full suite (1439 tests, ~12s)
