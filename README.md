...
[![tests](https://img.shields.io/badge/tests-1014%20passing-brightgreen.svg)](#trust)
...
**44 tools · 19 MCP prompts · 1014 unit tests · 50+ languages · v3.8.x stable · semver-bound · MIT · npm build provenance (SLSA L2).**
...
| **1014 unit tests · 9 required + 4 advisory CI gates per PR** | ✅ | n/a | rare |
...
npm test       # full suite (1014 tests, ~12s)
