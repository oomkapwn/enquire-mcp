...
[![tests](https://img.shields.io/badge/tests-1744%20contracts-brightgreen.svg)](#️-confiance)
...
**46 outils · 19 prompts MCP · 1744+ tests unitaires · 50+ langues · v3.11.x stable · lié au semver · MIT · provenance de build npm (SLSA L2).**
...
| **Confiance en production** | ✅ Lecture seule par défaut, filtres de confidentialité, HTTP authentifié, contrats semver, 1744 tests, 9 gates de publication et provenance SLSA L2 |
...
| **1744 tests unitaires · 9 contrôles CI requis pour la release · 7 actuellement protégés** | Posture de publication vérifiée ; le détail opérationnel est fixé ci-dessous. |
...
npm test       # suite complète (1744 tests)
