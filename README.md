...
[![tests](https://img.shields.io/badge/tests-868%20passing-brightgreen.svg)](#trust)
...
**44 tools · 19 MCP prompts · 868 unit tests · 50+ languages · v3.7.x stable · semver-bound · MIT · SLSA-3 signed.**
...
| **868 unit tests · 9 required + 4 advisory CI gates per PR** | ✅ | n/a | rare |
...
npm test       # full suite (868 tests, ~5s)
