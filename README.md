...
[![tests](https://img.shields.io/badge/tests-670%20passing-brightgreen.svg)](#trust)
...
**44 tools · 19 MCP prompts · 670 unit tests · 50+ languages · v3.5 · semver-bound · MIT · SLSA-3.**
...
| **670 unit tests · 8 required + 4 advisory CI gates per PR** | ✅ | n/a | rare |
...
npm test       # full suite (670 tests, ~5s)
