...
[![tests](https://img.shields.io/badge/tests-2207%20contracts-brightgreen.svg)](#️-confiance)
...
**46 outils · 19 prompts MCP · 2207+ tests unitaires · 50+ langues · v3.11.x stable · lié au semver · MIT · provenance de build npm (SLSA L2).**
...
| **Confiance en production** | ✅ Lecture seule par défaut, filtres de confidentialité, HTTP authentifié, contrats semver, 2207 tests, 13 gates de publication et provenance SLSA L2 |
...
| **2207 tests unitaires · 13 contrôles CI requis pour la release · les 13 actuellement protégés** | Posture de publication vérifiée ; le détail opérationnel est fixé ci-dessous. |
...
npm test       # suite complète (2207 tests)
