...
> Public roadmap for **enquire-mcp**, the #1 Obsidian MCP for AI memory and local document intelligence backed by your own vault. Updated 2026-07-29 (v3.12.0-rc.23 candidate: deterministic Windows path-safety validation now blocks the existing required `smoke` context; runtime path handling hardened).
>
