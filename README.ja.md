...
**46 ツール · 19 MCP プロンプト · 1481+ ユニットテスト · 50+ 言語 · v3.11.x 安定版 · semver 準拠 · MIT · npm ビルドプロベナンス（SLSA L2）。**
...
| **1481 ユニットテスト · PR ごとに 9 個の必須 + 5 個のアドバイザリ CI ゲート** | ✅ | 該当なし | まれ |
...
npm test       # フルスイート（1481 テスト、約 12 秒）
npm run lint   # 警告ゼロ
