...
[![tests](https://img.shields.io/badge/tests-1567%20passing-brightgreen.svg)](#️-доверие)
...
**46 инструментов · 19 MCP-промптов · 1567+ модульных тестов · 50+ языков · стабильная ветка v3.11.x · с гарантиями semver · MIT · подтверждённая сборка в npm (SLSA L2).**
...
| **1567 модульных тестов · 9 обязательных + 5 совещательных CI-гейтов на каждый PR** | ✅ | н/д | редко |
...
npm test       # полный набор (1567 тестов, ~12с)
